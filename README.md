...
### Backend · Data · AI
데이터를 기반으로 문제를 정의하고,  
부족한 실력이지만 백엔드와 분석 역량을 활용해 개발하고 싶은 프로젝트를 진행하고 있습니다.
...
저는 단순히 코드를 작성하는 것보다 "이 기능이 사용자에게 왜 필요한가?"를 고민하는 시간을 좋아합니다. 흩어진 데이터를 모아 가공해서 유의미한 인사이트를 발견할 때, 그리고 그 결과가 실제 서비스로 동작할 때 성취감을 느낍니다.
